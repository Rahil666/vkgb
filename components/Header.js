        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto">
            <li className="nav-item">
              <Link
                className={`nav-link ${LiveUrl == "/" ? "active" : ""}`}
                href="/"
              >
                Home
              </Link>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <Link className="dropdown-item" href="/company-timeline">
                    Company Timeline
                  </Link>
                </li>
              </ul>
            ...
            <li className="nav-item">
              <Link
                className={`nav-link ${
                  LiveUrl == "/project/infrastructures/" ? "" : ""
                }`}
                href="/project/infrastructures/"
              >
                PROJECTS
              </Link>
            </li>
            ...
            <li className="nav-item">
              <Link
                className={`nav-link ${LiveUrl == "/carrers" ? "active" : ""}`}
                href="/carrers"
              >
                CAREER
              </Link>
